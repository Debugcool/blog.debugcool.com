...
------------------------
v 2.6 
The theme is now responsive (i.e. mobile friendly)
It's been tested to look great on the iPhone, iPad and with WordPress vs 3.6 beta.

Minor fixes:
Updated quote post format to display same font as blockquote.
Moved the edit links for better ease of use when using smaller screens.
Fixed CSS for images in widgets which were displaying full height.
Adjusted the CSS of the form on password protected posts.
Removed comments from attachment template as the form remains even when comments are closed and attracts spammers.
The footer content is now all centered aligned. With the footer menu it didn't look good when right aligned.
